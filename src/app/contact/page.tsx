          ...
          <div className="contact-grid">
            <div>
              <div className="contact-method">
                <div className="contact-method-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <rect x="2" y="4" width="20" height="16" rx="2" stroke="#635BFF" strokeWidth="1.8" />
                    <path d="M2 8l10 6 10-6" stroke="#635BFF" strokeWidth="1.8" strokeLinecap="round" />
                  </svg>
                </div>
                <div>
              ...
              <div className="contact-method">
                <div className="contact-method-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <rect x="3" y="4" width="18" height="16" rx="2" stroke="#635BFF" strokeWidth="1.8" />
                    <path d="M3 9h18M9 9v11" stroke="#635BFF" strokeWidth="1.8" strokeLinecap="round" />
                  </svg>
                </div>
                <div>
                  <h3>Product demos</h3>
                  <p>
                    ...
                    <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--indigo)' }}>schedule directly →</a>
                  </p>
                </div>
              </div>
              ...
              <div className="contact-method">
                <div className="contact-method-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    ...
                    <path d="M8.5 9c.5-1.5 2-2.5 3.5-2.5 2 0 3.5 1.5 3.5 3 0 2-2 3-3.5 3v1.5" stroke="#635BFF" strokeWidth="1.8" strokeLinecap="round" />
                    <circle cx="12" cy="18" r=".5" fill="#635BFF" stroke="#635BFF" strokeWidth=".5" />
                  </svg>
                </div>
                <div>
            ...
            <div>
              ...
              <div style={{ marginTop: '16px', background: '#F4F3FF', borderRadius: 'var(--r)', padding: '22px', border: '1px solid #DDD9FF' }}>
